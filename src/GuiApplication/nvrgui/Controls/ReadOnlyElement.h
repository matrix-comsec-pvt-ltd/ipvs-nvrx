...
public:
    ReadOnlyElement(int startX,
                    ...
                    int suffixTextSize = SCALE_FONT(10),
                    bool isOuterBorderNeeded = true,
                    QString textValueFontColor = NORMAL_FONT_COLOR,
    ...
    void changeTextValueColor(QString fontColor);
    QString getCurrentValue() const;
    void updateElementPos(int);
