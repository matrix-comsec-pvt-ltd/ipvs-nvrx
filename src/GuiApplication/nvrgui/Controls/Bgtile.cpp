...
BgTile::BgTile(int startX,
               ...
               QWidget* parent, int indexInPage): KeyBoard(parent)
{
    m_startX = startX;
    m_startY = startY;
    m_width = width;
...
void BgTile:: drawRect(QPainter *painter, QColor color, QRect rect)
{
...
void BgTile::paintEvent(QPaintEvent* event)
{
    ...
    {
        drawRect(&painter, NORMAL_BKG_COLOR, m_mainRect);
    }
    ...
    case COMMON_LAYER:
    {
        drawRect(&painter, BORDER_2_COLOR, m_leftBorderRect);
        drawRect(&painter, BORDER_1_COLOR, m_rightBorderRect);
        drawRect(&painter, BORDER_1_COLOR, m_topBorderRect);
        drawRect(&painter, BORDER_2_COLOR, m_bottomBorderRect);
    }
    break;
    ...
    case COMMON_BOTTOM_LAYER:
    {
        ...
        drawRect(&painter, BORDER_1_COLOR, m_rightBorderRect);
        drawRect(&painter, BORDER_1_COLOR, m_topBorderRect);
        drawRect(&painter, BORDER_1_COLOR, m_bottomBorderRect);
    }
    break;
    ...
    case TOP_TABLE_LAYER:
    {
        ...
        drawRect(&painter, BORDER_1_COLOR, m_rightBorderRect);
        drawRect(&painter, BORDER_1_COLOR, m_topBorderRect);
        drawRect(&painter, BORDER_2_COLOR, m_innerLeftBorderRect);
        drawRect(&painter, BORDER_1_COLOR, m_innerRightBorderRect);
        drawRect(&painter, BORDER_1_COLOR, m_innerTopBorderRect);
    }
    break;
    ...
    case MIDDLE_TABLE_LAYER:
    {
        ...
        drawRect(&painter, BORDER_1_COLOR, m_innerRightBorderRect);
        drawRect(&painter, BORDER_1_COLOR, m_innerTopBorderRect);
        drawRect(&painter, BORDER_2_COLOR, m_innerBottomBorderRect);
    ...
    case TIMEBAR_LAYER:
    {
        drawRect(&painter, TIME_BAR_COLOR, m_mainRect);
    }
    break;

    case BLACK_COLOR_LAYER:
    {
        drawRect(&painter, CLICKED_BKG_COLOR, m_mainRect);
    }
    break;
