...
QT_MOC_LITERAL(1, 9, 23), // "sigInfoPageCnfgBtnClick"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 5), // "index"
QT_MOC_LITERAL(4, 40, 24), // "slotUpdateCurrentElement"
QT_MOC_LITERAL(5, 65, 18) // "slotCnfgBtnClicked"

    },
    "InfoPage\0sigInfoPageCnfgBtnClick\0\0"
...
void InfoPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->sigInfoPageCnfgBtnClick((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->slotUpdateCurrentElement((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->slotCnfgBtnClicked((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (InfoPage::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&InfoPage::sigInfoPageCnfgBtnClick)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void InfoPage::sigInfoPageCnfgBtnClick(int _t1)
{
