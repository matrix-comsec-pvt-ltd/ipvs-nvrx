...
QT_MOC_LITERAL(1, 17, 24), // "slotSelectionButtonClick"
QT_MOC_LITERAL(2, 42, 0), // ""
QT_MOC_LITERAL(3, 43, 19), // "OPTION_STATE_TYPE_e"
QT_MOC_LITERAL(4, 63, 15), // "slotButtonClick"
QT_MOC_LITERAL(5, 79, 5), // "index"
QT_MOC_LITERAL(6, 85, 18), // "slotSubOjectDelete"
QT_MOC_LITERAL(7, 104, 16), // "slotLoadInfoPage"
QT_MOC_LITERAL(8, 121, 15) // "INFO_MSG_TYPE_e"

    },
    "StorageManagment\0slotSelectionButtonClick\0"
    "\0OPTION_STATE_TYPE_e\0slotButtonClick\0"
    "index\0slotSubOjectDelete\0slotLoadInfoPage\0"
    "INFO_MSG_TYPE_e"
};
...
void StorageManagment::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->slotSelectionButtonClick((*reinterpret_cast< OPTION_STATE_TYPE_e(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 1: _t->slotButtonClick((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->slotSubOjectDelete((*reinterpret_cast< quint8(*)>(_a[1]))); break;
        case 3: _t->slotLoadInfoPage((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< INFO_MSG_TYPE_e(*)>(_a[2]))); break;
        default: ;
        }
    }
}
