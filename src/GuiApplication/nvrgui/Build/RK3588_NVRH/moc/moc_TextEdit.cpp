...
QT_MOC_LITERAL(3, 25, 9), // "isFocusIn"
QT_MOC_LITERAL(4, 35, 10) // "forceFocus"

    },
    "TextEdit\0sigFocusChange\0\0isFocusIn\0"
    "forceFocus"
};
...
void TextEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->sigFocusChange((*reinterpret_cast< bool(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (TextEdit::*)(bool , bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TextEdit::sigFocusChange)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TextEdit::sigFocusChange(bool _t1, bool _t2)
{
