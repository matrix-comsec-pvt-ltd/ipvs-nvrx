...
QT_MOC_LITERAL(1, 10, 9), // "sigScroll"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 13), // "numberOfSteps"
QT_MOC_LITERAL(4, 35, 23), // "sigUpdateCurrentElement"
QT_MOC_LITERAL(5, 59, 5), // "index"
QT_MOC_LITERAL(6, 65, 16), // "slotImageClicked"
QT_MOC_LITERAL(7, 82, 11), // "indexInPage"
QT_MOC_LITERAL(8, 94, 24) // "slotUpdateCurrentElement"

    },
    "ScrollBar\0sigScroll\0\0numberOfSteps\0"
    "sigUpdateCurrentElement\0index\0"
    "slotImageClicked\0indexInPage\0"
...
void ScrollBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->sigScroll((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            using _t = void (ScrollBar::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ScrollBar::sigScroll)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ScrollBar::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ScrollBar::sigUpdateCurrentElement)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void ScrollBar::sigScroll(int _t1)
{
...
// SIGNAL 1
void ScrollBar::sigUpdateCurrentElement(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
