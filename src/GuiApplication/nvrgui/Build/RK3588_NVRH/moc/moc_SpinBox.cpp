...
QT_MOC_LITERAL(1, 8, 15), // "sigValueChanged"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 6), // "string"
QT_MOC_LITERAL(4, 32, 11), // "indexInPage"
QT_MOC_LITERAL(5, 44, 23), // "sigUpdateCurrentElement"
QT_MOC_LITERAL(6, 68, 5) // "index"

    },
    "SpinBox\0sigValueChanged\0\0string\0"
...
void SpinBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (SpinBox::*)(QString , quint32 );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SpinBox::sigValueChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SpinBox::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SpinBox::sigUpdateCurrentElement)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void SpinBox::sigValueChanged(QString _t1, quint32 _t2)
{
...
// SIGNAL 1
void SpinBox::sigUpdateCurrentElement(int _t1)
{
