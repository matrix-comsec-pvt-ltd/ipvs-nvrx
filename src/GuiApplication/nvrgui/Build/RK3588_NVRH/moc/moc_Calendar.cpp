...
QT_MOC_LITERAL(1, 9, 13), // "sigUpdateDate"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 15), // "DDMMYY_PARAM_t*"
QT_MOC_LITERAL(4, 40, 5), // "param"
QT_MOC_LITERAL(5, 46, 17), // "slotImagesClicked"
QT_MOC_LITERAL(6, 64, 5), // "index"
QT_MOC_LITERAL(7, 70, 18), // "slotDateBoxClicked"
QT_MOC_LITERAL(8, 89, 21) // "slotUpdateCurrElement"

    },
    "Calendar\0sigUpdateDate\0\0DDMMYY_PARAM_t*\0"
    "param\0slotImagesClicked\0index\0"
    "slotDateBoxClicked\0slotUpdateCurrElement"
};
...
void Calendar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->sigUpdateDate((*reinterpret_cast< DDMMYY_PARAM_t*(*)>(_a[1]))); break;
        case 1: _t->slotImagesClicked((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->slotDateBoxClicked((*reinterpret_cast< quint32(*)>(_a[1]))); break;
        case 3: _t->slotUpdateCurrElement((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Calendar::*)(DDMMYY_PARAM_t * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Calendar::sigUpdateDate)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Calendar::sigUpdateDate(DDMMYY_PARAM_t * _t1)
{
