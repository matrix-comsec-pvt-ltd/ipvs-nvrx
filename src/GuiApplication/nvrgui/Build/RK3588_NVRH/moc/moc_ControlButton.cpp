...
QT_MOC_LITERAL(1, 14, 14), // "sigButtonClick"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 5), // "index"
QT_MOC_LITERAL(4, 36, 23), // "sigUpdateCurrentElement"
QT_MOC_LITERAL(5, 60, 27) // "slotClickEffectTimerTimeout"

    },
    "ControlButton\0sigButtonClick\0\0index\0"
...
void ControlButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ControlButton::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ControlButton::sigButtonClick)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ControlButton::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ControlButton::sigUpdateCurrentElement)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ControlButton::staticMetaObject = { {
    QMetaObject::SuperData::link<BgTile::staticMetaObject>(),
    qt_meta_stringdata_ControlButton.data,
    qt_meta_data_ControlButton,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void ControlButton::sigButtonClick(int _t1)
{
...
// SIGNAL 1
void ControlButton::sigUpdateCurrentElement(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
