...
QT_MOC_LITERAL(5, 53, 22), // "slotCloseButtonClicked"
QT_MOC_LITERAL(6, 76, 11) // "indexInPage"

    },
    "BackGround\0sigClosePage\0\0TOOLBAR_BUTTON_TYPE_e\0"
    "index\0slotCloseButtonClicked\0indexInPage"
};
...
void BackGround::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (BackGround::*)(TOOLBAR_BUTTON_TYPE_e );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BackGround::sigClosePage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void BackGround::sigClosePage(TOOLBAR_BUTTON_TYPE_e _t1)
{
