...
QT_MOC_LITERAL(1, 7, 18), // "sigCloseBtnClicked"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 15), // "slotCtrlClicked"
QT_MOC_LITERAL(4, 43, 5) // "index"

    },
    "Report\0sigCloseBtnClicked\0\0slotCtrlClicked\0"
    "index"
};
...
void Report::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->sigCloseBtnClicked(); break;
        case 1: _t->slotCtrlClicked((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Report::sigCloseBtnClicked)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Report::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_Report.data,
    qt_meta_data_Report,
    qt_static_metacall,
    nullptr,
    nullptr
...
// SIGNAL 0
void Report::sigCloseBtnClicked()
{
