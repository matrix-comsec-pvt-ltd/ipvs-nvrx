...
#define BGTILE_SMALL_SIZE_WIDTH            (410)
#define BGTILE_MEDIUM_SIZE_WIDTH           (486)
#define BGTILE_ULTRAMEDIUM_SIZE_WIDTH      (680)
#define BGTILE_LARGE_SIZE_WIDTH            (978)
#define BGTILE_EXTRALARGE_SIZE_WIDTH       (1245)
#define BGTILE_ULTRALARGE_SIZE_WIDTH       (1110)

#define BGTILE_HEIGHT                      (40)
