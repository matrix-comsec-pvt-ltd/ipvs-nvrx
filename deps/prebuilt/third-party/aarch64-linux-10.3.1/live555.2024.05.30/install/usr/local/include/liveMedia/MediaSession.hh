...
public:
  ...
  // MATRIX PATCH: START
  char* controlEndpointName() const { return fControlEndpointName; }
  int controlEndpointNameAddressFamily() const { return fControlEndpointNameAddressFamily; }
  // MATRIX PATCH: END
...
protected:
  ...
  // MATRIX PATCH: START
  char* fControlEndpointName;
  int fControlEndpointNameAddressFamily;
  // MATRIX PATCH: END
...
public:
  ...
  // MATRIX PATCH: START
  char*& controlEndpointName() { return fControlEndpointName; }
  char const* controlEndpointName() const {
    return fControlEndpointName;
  }
  int controlEndpointNameAddressFamily() const {
    return fControlEndpointNameAddressFamily == AF_UNSPEC
      ? parentSession().controlEndpointNameAddressFamily()
      : fControlEndpointNameAddressFamily;
  }
  // MATRIX PATCH: END
